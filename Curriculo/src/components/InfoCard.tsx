...
export const InfoCard = ({ title, subtitle, footer, onEdit, onDelete }: InfoCardProps) => {
  ...
  return (
    <View style={[styles.card, { backgroundColor: theme.card, borderLeftColor: theme.primary }]}>
      <View style={{ flex: 1 }}>
        ...
        {footer && <Text style={[styles.footer, { color: theme.primary, opacity: 0.8 }]}>{footer}</Text>}
      </View>
...
const styles = StyleSheet.create({
  ...
  footer: { fontSize: 12, marginTop: 4, fontWeight: 'bold' },
